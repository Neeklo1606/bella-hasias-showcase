  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Подбор образа на мероприятие в Москве. Стилизация для свадьбы, корпоратива, вечеринки или важной встречи." />
        <meta name="keywords" content="образ на мероприятие, подбор лука, стилист для события Москва" />
        <meta property="og:title" content="Образ на мероприятие — Bella Hasias" />
        <meta property="og:description" content="Подбор образа на мероприятие в Москве." />
      </Helmet>
          ...
          <div className="max-w-5xl mx-auto">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
              <div className="relative overflow-hidden rounded-3xl aspect-[4/5]">
                <img src={user1} alt="Образ на мероприятие — стилист подбор лука" loading="lazy" className="w-full h-full object-cover" />
