  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Персональный шоппинг в Москве со стилистом. Составление шоп-листа, совместные покупки, подбор идеального гардероба." />
        <meta name="keywords" content="персональный шоппинг, шоппинг со стилистом, шоп-лист Москва" />
        <meta property="og:title" content="Персональный шоппинг — Bella Hasias" />
        <meta property="og:description" content="Персональный шоппинг в Москве со стилистом." />
      </Helmet>
          ...
          <div className="max-w-5xl mx-auto">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
              <div className="relative overflow-hidden rounded-3xl aspect-[4/5]">
                <img src={heroRight} alt="Персональный шоппинг со стилистом в Москве" loading="lazy" className="w-full h-full object-cover" />
