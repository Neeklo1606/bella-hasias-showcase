...
const steps = [
  'Брифинг и определение задачи',
  'Разработка креативной концепции',
  'Съёмка фото и/или видео',
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Создание креативного фото и видео контента для брендов и блогеров в Москве. Профессиональная съёмка, постобработка, готовые материалы для соцсетей." />
          ...
          <div className="max-w-5xl mx-auto">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
              <div className="relative overflow-hidden rounded-3xl aspect-[4/5]">
                <img src={servicePhotographer} alt="Фото и видео контент" className="w-full h-full object-cover" />
              ...
              <div>
                ...
                <p className="font-sans text-muted-foreground mb-8 leading-relaxed">
                  Креативный визуальный контент для брендов и блогеров. Создаю стильные фото и видео, которые 
                  привлекают внимание и работают на вашу аудиторию. От концепции до готовых материалов.
                </p>
