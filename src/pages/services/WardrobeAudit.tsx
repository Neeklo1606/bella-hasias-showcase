  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Профессиональный разбор гардероба в Москве. Анализ вещей, сборка образов, рекомендации по покупкам." />
        <meta name="keywords" content="разбор гардероба, анализ гардероба, стилист Москва, капсульный гардероб" />
        <meta property="og:title" content="Разбор гардероба — Bella Hasias" />
        <meta property="og:description" content="Профессиональный разбор гардероба в Москве." />
      </Helmet>
          ...
          <div className="max-w-5xl mx-auto">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
              <div className="relative overflow-hidden rounded-3xl aspect-[4/5]">
                <img src={heroCenter} alt="Разбор гардероба — стилист анализ вещей" loading="lazy" className="w-full h-full object-cover" />
