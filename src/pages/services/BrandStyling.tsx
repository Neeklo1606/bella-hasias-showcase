  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:title" content="Стилизация съёмки — Bella Hasias" />
        <meta property="og:description" content="Профессиональная стилизация съёмок для брендов в Москве." />
      </Helmet>
        ...
        <section className="pt-32 pb-20 px-6 md:px-10">
          <div className="max-w-5xl mx-auto">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
              ...
              <div>
                <h1 className="font-display text-h1 text-foreground mb-6">Стилизация съёмки</h1>
