  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Создание AI-контента для digital и SMM. Генерация уникальных визуалов с помощью искусственного интеллекта." />
        <meta name="keywords" content="AI контент, генерация изображений, digital контент, SMM визуалы" />
        <meta property="og:title" content="AI-контент — Bella Hasias" />
        <meta property="og:description" content="Создание AI-контента для digital и SMM." />
      </Helmet>
          ...
          <div className="max-w-5xl mx-auto">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
              <div className="relative overflow-hidden rounded-3xl aspect-[4/5]">
                <img src={work3} alt="AI-контент для digital и SMM" loading="lazy" className="w-full h-full object-cover" />
